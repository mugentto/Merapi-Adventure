    ...
    <div class="carousel-inner" role="listbox">
        ...
        foreach ($querywisata as $gambar) {
            ...
            <div class="carousel-item <?php if ($no == '1') {
                ...
                <img src="assets/image/<?= $gambar['wisata']; ?>" alt="First slide" class="img-fluid mx-auto d-block"
                    style="object-fit:cover;width:auto;height:400px;">
            </div>
            <?php $no++;
        } ?>
    </div>
            ...
            <div class="card" style=" background: #ddd">
                <div class="card-body">
                    <?php if ($_SESSION['USER'] ?? null) { ?>
                        <p>Selamat Datang , <?php echo $_SESSION['USER']['nama_pengguna']; ?></p>
                        <br />
                        <br />
                        <center>
                ...
                foreach ($query as $isi) {
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <center><a href="booking.php?id=<?php echo $isi['id_rute']; ?>"
                                        class="btn btn-success">Booking now!</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="koneksi/proses.php?id=daftar">
                    ...
                    <div class="form-group">
                        <label for="">Username</label>
                        <input type="text" name="user" id="" class="form-control" required placeholder=""
                            aria-describedby="helpId">
                    </div>
                    <div class="form-group">
                        <label for="">Password</label>
                        <input type="password" name="pass" id="" class="form-control" required placeholder=""
                            aria-describedby="helpId">
                    </div>
            </div>
