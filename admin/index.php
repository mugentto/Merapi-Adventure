<?php
    ...
    if(!empty($_POST['corp_name']))
    {
        $data[] =  htmlspecialchars($_POST["corp_name"]);
        $data[] =  htmlspecialchars($_POST["tlp"]);
        $data[] =  htmlspecialchars($_POST["alamat"]);
        $data[] =  htmlspecialchars($_POST["email"]);
        $data[] =  htmlspecialchars($_POST["no_rek"]);
        $data[] =  1;
        $sql = "UPDATE infoweb SET corp_name = ?, tlp = ?, alamat = ?, email = ?, no_rek = ?  WHERE id = ? ";
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?= $edit->corp_name;?>" name="corp_name" id="corp_name" placeholder=""/>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $edit->tlp;?>" name="tlp" id="tlp" placeholder=""/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
