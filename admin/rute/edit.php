...
<div class="container">
    <div class="card">
        <div class="card-header text-white bg-primary">
            <h4 class="card-title">
                Edit Rute - <?= $hasil['nama_paket'];?>
                <div class="float-right">
                    <a class="btn btn-warning" href="rute.php" role="button">Kembali</a>
                </div>
            </h4>
        </div>
        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9"  value="<?= $hasil['nama_paket'];?>" name="nama_paket" placeholder="Isi Nama Paket">
                            </div>
